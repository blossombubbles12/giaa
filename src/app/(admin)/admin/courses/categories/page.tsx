...
import { Plus, Search, Layers, Edit, Trash2, Loader2, ChevronRight } from 'lucide-react';
        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-slate-400 text-sm mt-1">Manage categories to organize your courses</p>
                </div>

                <Dialog open={isCreateOpen} onOpenChange={setIsCreateOpen}>
                    <DialogTrigger asChild>
                        <Button onClick={openCreate} className="bg-blue-600 hover:bg-blue-500 text-white rounded-xl gap-2 shadow-md shadow-blue-600/25">
                            <Plus size={16} />
                            Add Category
                        </Button>
                    </DialogTrigger>
                        ...
                        <form onSubmit={handleCreate}>
                            <DialogHeader>
                                ...
                                <DialogDescription className="text-slate-400">
                                    Add a new category to group your training courses.
                                </DialogDescription>
                            </DialogHeader>
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-2xl overflow-hidden shadow-xl">
                ...
                {loading ? (
                    ...
                    <div className="p-20 text-center">
                        ...
                        <p className="text-slate-500 text-sm mt-1">Start by creating a new category for your courses.</p>
                    </div>
                ) : (
                    ...
                    <form onSubmit={handleUpdate}>
                        ...
                        <DialogFooter>
                            <Button
                                ...
                                className="w-full bg-blue-600 hover:bg-blue-500 text-white rounded-xl h-11 shadow-lg shadow-blue-600/20 gap-2"
                            >
                                {isSubmitting ? <Loader2 className="w-4 h-4 animate-spin" /> : <Edit size={16} />}
                                Update Category
                            </Button>
                        </DialogFooter>
                    </form>
            ...
            <Dialog open={isDeleteOpen} onOpenChange={setIsDeleteOpen}>
                <DialogContent className="bg-slate-900 border-slate-800 text-white sm:max-w-[400px]">
                    <DialogHeader>
                        ...
                        <DialogDescription className="text-slate-400">
                            Are you sure you want to delete the category <span className="text-white font-bold">&quot;{currentCategory?.name}&quot;</span>? This action cannot be undone.
                        </DialogDescription>
                    </DialogHeader>
                    <DialogFooter className="mt-4 gap-3 sm:gap-0">
                        <Button
                            ...
                            className="text-slate-400 hover:text-white hover:bg-slate-800 rounded-xl h-11"
                        >
                            Cancel
                        </Button>
                        <Button
                            ...
                            disabled={isSubmitting}
                            className="bg-red-600 hover:bg-red-500 text-white rounded-xl h-11 px-8 gap-2"
                        >
                            {isSubmitting ? <Loader2 className="w-4 h-4 animate-spin" /> : <Trash2 size={16} />}
                            Delete Permanently
                        </Button>
                    </DialogFooter>
                </DialogContent>
